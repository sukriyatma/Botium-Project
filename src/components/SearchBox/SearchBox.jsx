...
export default function SearchBox(props) {
    ...
    return (
        <div style={{width: '75%', borderRadius: '0.7vw', backgroundColor: '#161623', height: '2.7vw', display: 'flex', flexDirection: 'row', alignItems: 'center', paddingLeft: '1.1vw'}}>
            <svg xmlns="http://www.w3.org/2000/svg" width="1.2vw" height="1.2vw" viewBox="0 0 20 20" fill="none">
            ...
            <input type="text" placeholder="Search" spellCheck='false' style={{width: '100%', height: '2.5vw', borderRadius: '0.7vw', backgroundColor: '#161623', border: 'none', fontFamily: 'Poppins', fontWeight: 500, fontSize: '0.83vw' }}/>
        </div>
    )
